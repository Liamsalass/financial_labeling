...
@click.command()
@click.option('-d', '--data-cnf', type=click.Path(exists=True), help='Path of dataset configure yaml.', default='configure/datasets/FINER-139.yaml')
@click.option('-m', '--model-cnf', type=click.Path(exists=True), help='Path of model configure yaml.', default='configure/models/AttentionXML-FINER-139.yaml')
